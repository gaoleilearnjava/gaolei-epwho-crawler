...
public class DownloadAndUploadUtils {
    public static String downloadPicture(String urlStr) throws Exception {
        //读取fastdfs文件路径
        com.gaolei.crawler.util.FastDFSClient fastDFSClient = new com.gaolei.crawler.util.FastDFSClient("D://fastdfs-client.properties");
        ...
        out.close();
        is.close();
        return "http://49.4.84.15/" + fastDFSClient.uploadFile(pathname, exname);
    }
}
